...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 15 avr. 2021 à 14:10
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `themeFavori` varchar(80) NOT NULL,
...
ALTER TABLE `photo`
  ...
  ADD CONSTRAINT `Photo_etape_FK` FOREIGN KEY (`idetape`) REFERENCES `etape` (`idetape`);
